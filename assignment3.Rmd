...
where $K_h(x)=\frac{K(x)}{h}$, $K$ is a kernel and $h>0$ is a parameter controlling smootheness of the estimate. This is avaiable as the base function of `R` as `density()`. 
...
(Deng et al, 2011)[1] then further suggested the simplified kernel apporach 
$$
